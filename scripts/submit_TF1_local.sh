...
SHARED=/Users/aagam2/Desktop/UIUC_Offline/TF1-Bridges2
# Input data
...
LOCALDIR=${SHARED}/local-runs/${RUNDIR}     # RUNDIR on node-local filesystem for bridges-2
...
python main.py --augment --batch_size 8 --nepochs 2 --input_size 512 --input_dir $DATADIR 2>&1 | tee out.log
